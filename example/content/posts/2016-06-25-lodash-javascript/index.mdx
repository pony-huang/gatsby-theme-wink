---
title: Lodash
description: 辅助工具库 Lodash 的模块组成、使用方法
date: '2016-06-25T01:05:50.000Z'
published: true
...
![lodash-example1-2016-06-26](http://filimanjaro.com/blog/wp-content/uploads/2014/11/lodash-naive.gif)

假设有如上图所示的问题：从若干个球中取出三个面值小于 10 的球。第一步是从所有的球中取出所有面值小于 10 的球，第二步是从上一步的结果取三个球。

![lodash-example2-2016-06-26](http://filimanjaro.com/blog/wp-content/uploads/2014/11/grafika.gif)
