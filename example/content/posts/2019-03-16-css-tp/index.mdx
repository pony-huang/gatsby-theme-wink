...
![Medium posts are exported as html files](./v2.png 'Medium posts are exported as html files')
...
![Converted posts in markdown format](./v3.png)
...
![What your folder structure should look like](./v4.png 'What your folder structure should look like')
...
![Run a lighthouse audit on your site in the Chrome DevTools](./v5.png 'Run a lighthouse audit on your site in the Chrome DevTools')
...
![lighthousebot will leave a comment in your PR](./v6.png 'lighthousebot will leave a comment in your PR')
...
![What your TravisCI environment variables should look like](./v8.png 'What your TravisCI environment variables should look like')
...
![Your TravisCI stages should look like this](./v7.png 'Your TravisCI stages should look like this')
