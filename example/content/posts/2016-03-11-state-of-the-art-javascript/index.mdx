...
published: true
cover: ./samuel-zeller-0rxmzg-Q1Lk-unsplash.jpg
coverAuthor: Samuel Zeller
coverOriginalUrl: https://unsplash.com/photos/0rxmzg-Q1Lk
---
...
那么是否需要类型系统呢？TypeScript 和 Flow 都为 JavaScript 提供了静态类型系统，使用静态类型检查，可以有效捕获错误，减少测试量。目前来说，我建议对此持观望态度。
